...
export default class FAQSection extends Component {
  ...
  render() {
    return (
      <div className="faq">
        <div className="faq-columns">
          <FAQColumn question={this.questions[0]} answer={this.answers[0]} />
          <FAQColumn question={this.questions[1]} answer={this.answers[1]} />
          <FAQColumn question={this.questions[2]} answer={this.answers[2]} />
        </div>
      </div>
    );
  }
